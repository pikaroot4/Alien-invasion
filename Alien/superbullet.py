...
# Süper mermiler, gemi tarafından ateşlenen ve
# ekranın yukarısına doğru hareket eden daha güçlü mermilerdir.
...
class Superbullet(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # başlangıç dikey konumunu (y) kendi yüksekliğine ayarlar.
