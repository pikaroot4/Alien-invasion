...
class AlienInvasion:
    ...
    def _check_aliens_bottom(self):
        """Checking for alien ship to get to the bottom of the screen"""
        # Burada uzaylıların alt tarafa çarpıp çarpmadığını kontrol ediyoruz.
    ...
    def _create_starry_sky(self):
        """Creating starry sky"""
        # Burada Yıldızlı Arka planın random olarak oluşturulduğu kısım.
        star = Star(self)
    ...
    def _update_screen(self):
        ...
        #Oyun etkin değilse Oynat düğmesinin görüntülenmesi
